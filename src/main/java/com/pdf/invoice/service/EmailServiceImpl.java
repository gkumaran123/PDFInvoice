...
public class EmailServiceImpl implements EmailService {
	...
	public String sendSimpleMail(EmailDetails details)
	{
		...
		try {
			...
			return "Mail Sent Successfully...our Employee will contact you shortly";
		}
	...
	sendMailWithAttachment(EmailDetails details)
	{
		 ...
		 * // Creating a mime message MimeMessage mimeMessage =
		 * javaMailSender.createMimeMessage(); MimeMessageHelper mimeMessageHelper;
		 * 
		 * try {
		 * 
		 ...
		 * 
		 * // Sending the mail javaMailSender.send(mimeMessage); return
